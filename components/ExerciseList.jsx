    ...
    <div className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        <button
          ...
          className="px-2.5 py-1 text-xs font-medium text-blue-600 hover:bg-blue-100 rounded-md transition focus:outline-none focus:ring-2 focus:ring-blue-400"
        >
          Edit
        </button>
        <button
          onClick={() => { if (window.confirm(`Delete ${exercise.name}?`)) onDelete(exercise.id); }}
          className="px-2.5 py-1 text-xs font-medium text-red-500 hover:bg-red-100 rounded-md transition focus:outline-none focus:ring-2 focus:ring-red-400"
        >
          Delete
        </button>
      </div>
